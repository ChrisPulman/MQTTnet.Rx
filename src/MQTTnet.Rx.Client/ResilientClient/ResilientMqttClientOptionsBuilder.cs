...
/// <summary>Builds the options used by a resilient MQTT client.</summary>
...
{
    /// <summary>Stores the options being configured.</summary>
    private readonly ResilientMqttClientOptions _options = new();

    /// <summary>Stores the builder used to construct MQTT client options.</summary>
    private MqttClientOptionsBuilder? _clientOptionsBuilder;

    /// <summary>Sets the maximum number of pending messages.</summary>
    ...
    /// <summary>Sets the strategy to use when the pending messages queue exceeds its capacity.</summary>
    ...
    /// <returns>The current <see cref="ResilientMqttClientOptionsBuilder"/> instance for method chaining.</returns>
    public ResilientMqttClientOptionsBuilder WithPendingMessagesOverflowStrategy(
        MqttPendingMessagesOverflowStrategy value)
    {
        _options.PendingMessagesOverflowStrategy = value;
        return this;
    }

    /// <summary>Sets the delay between automatic reconnection attempts.</summary>
    ...
    /// <param name="value">The time interval to wait before each automatic reconnection attempt. Must be a non-negative
    /// duration.</param>
    /// <returns>The current <see cref="ResilientMqttClientOptionsBuilder"/> instance for method chaining.</returns>
    ...
    /// <summary>Sets the storage provider to be used for persisting client state and messages.</summary>
    ...
    /// <param name="value">The storage implementation that handles persistence for the MQTT client. Cannot be
    /// null.</param>
    /// <returns>The current <see cref="ResilientMqttClientOptionsBuilder"/> instance for method chaining.</returns>
    ...
    /// <summary>Sets the MQTT client options to use for the connection.</summary>
    ...
    /// <exception cref="InvalidOperationException">Thrown if client options have already been set using a client
    /// options builder.</exception>
    /// <exception cref="ArgumentNullException">Thrown if <paramref name="value"/> is null.</exception>
    public ResilientMqttClientOptionsBuilder WithClientOptions(MqttClientOptions value)
    {
        if (_clientOptionsBuilder is not null)
        {
            throw new InvalidOperationException(
                "Cannot use client options builder and client options at the same time.");
        }
    ...
    /// <summary>Configures the MQTT client options using the specified builder.</summary>
    ...
    /// <exception cref="InvalidOperationException">Thrown if client options have already been set directly, as both a
    /// client options builder and direct client
    ...
    {
        if (_options.ClientOptions is not null)
        {
            throw new InvalidOperationException(
                "Cannot use client options builder and client options at the same time.");
        }
    ...
    /// <summary>Configures the underlying MQTT client options using the specified configuration action.</summary>
    ...
    /// <param name="options">An action that receives an <see cref="MqttClientOptionsBuilder"/> to configure client
    /// options. Cannot be null.</param>
    /// <returns>The current <see cref="ResilientMqttClientOptionsBuilder"/> instance for method chaining.</returns>
    public ResilientMqttClientOptionsBuilder WithClientOptions(
        Action<MqttClientOptionsBuilder> options)
    {
    ...
    /// <summary>Sets the maximum number of topic filters in a subscribe or unsubscribe packet.</summary>
    ...
    /// <param name="value">The maximum number of topic filters permitted in a single SUBSCRIBE or UNSUBSCRIBE packet.
    /// Must be a positive
    /// integer.</param>
    /// <returns>The current <see cref="ResilientMqttClientOptionsBuilder"/> instance with the updated
    /// setting.</returns>
    public ResilientMqttClientOptionsBuilder WithMaxTopicFiltersInSubscribeUnsubscribePackets(
        int value)
    {
    ...
    /// <summary>Builds and returns a configured instance of the resilient MQTT client options.</summary>
    ...
    public ResilientMqttClientOptions Build()
    {
        ...
        if (_options.ClientOptions is null)
        {
