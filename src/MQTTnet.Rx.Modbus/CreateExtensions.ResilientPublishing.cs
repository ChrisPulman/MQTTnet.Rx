...
{
    /// <summary>Extends a resilient MQTT client sequence with Modbus operations.</summary>
    ...
    extension(IObservable<IResilientMqttClient> client)
    {
        ...
        public IObservable<ApplicationMessageProcessedEventArgs> PublishInputRegisters(
        ...
        /// <param name="numberOfPoints">The number of registers.</param>
        /// <returns>The publish result sequence.</returns>
        public IObservable<ApplicationMessageProcessedEventArgs> PublishHoldingRegisters(
            IObservable<ModbusMasterState> modbus,
            string topic,
            ushort startAddress,
            ushort numberOfPoints) =>
        ...
        /// <returns>The publish result sequence.</returns>
        public IObservable<ApplicationMessageProcessedEventArgs> PublishInputs(
            IObservable<ModbusMasterState> modbus,
            string topic,
            ushort startAddress,
            ushort numberOfPoints) =>
        ...
        /// <returns>The publish result sequence.</returns>
        public IObservable<ApplicationMessageProcessedEventArgs> PublishCoils(
            IObservable<ModbusMasterState> modbus,
            string topic,
            ushort startAddress,
            ushort numberOfPoints) =>
        ...
        /// <returns>The publish result sequence.</returns>
        public IObservable<ApplicationMessageProcessedEventArgs> PublishModbus<TPayload>(
