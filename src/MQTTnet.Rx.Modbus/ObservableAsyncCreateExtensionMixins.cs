...
public static partial class ObservableAsyncCreateExtensionMixins
{
    ...
    /// <param name="client">The asynchronous standard MQTT client sequence.</param>
    extension(IObservableAsync<IMqttClient> client)
    {
        ...
        public PublishResult PublishInputRegisters(
        ...
        /// <param name="numberOfPoints">The number of registers.</param>
        /// <returns>The asynchronous publish result sequence.</returns>
        public PublishResult PublishHoldingRegisters(
            ModbusMasterSignal modbus,
            string topic,
            ushort startAddress,
            ushort numberOfPoints) =>
        ...
        /// <returns>The asynchronous publish result sequence.</returns>
        public PublishResult PublishInputs(
            ModbusMasterSignal modbus,
            string topic,
            ushort startAddress,
            ushort numberOfPoints) =>
        ...
        /// <returns>The asynchronous publish result sequence.</returns>
        public PublishResult PublishCoils(
            ModbusMasterSignal modbus,
            string topic,
            ushort startAddress,
            ushort numberOfPoints) =>
        ...
        /// <returns>The asynchronous publish result sequence.</returns>
        public PublishResult PublishModbus<TPayload>(
